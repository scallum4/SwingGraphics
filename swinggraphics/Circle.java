...
public class Circle extends Shape{
     ...
     */
    public Circle(int width, int height, double xPos, double yPos, String colour, int layer){
     ...
     */
    public Circle(int width, int height, double xPos, double yPos, String colour, int layer, int angle){
